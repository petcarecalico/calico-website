...
const DownloadNav = ({ onClose }) => {
    ...
    return (
        <div className="p-5">
            <div className="lg:h-[576px] w-[100%] h-[661px] rounded-[42px] md:rounded-[112px] bg-[#EEEDE2] flex flex-col lg:flex-row items-center justify-between shadow-[0_0_0px_0_#6366F1] mx-auto md:mx-auto ">
                {/* Left Side */}
                <div className="w-[80%] lg:w-[60%] max-w-[550px] flex flex-col  pl-[0px] lg:pl-[84px] py-[38px] md:py-[0px] pt-[38px] pb-[38px] md:pt-[38px] md:pb-[38px] lg:pb-[0px] lg:py-[0px] justify-between  items-center relative">
                    <div className="">
                        <video
                            src="/videos/coming-soon.webm"
                            autoPlay
                            muted
                            loop
                            playsInline
                        ...
                        />
                        <div className="flex justify-center items-center h-[36px] gap-[6px] p-3 w-auto rounded-[16px] bg-[#0000001F] lg:hidden absolute top-5 -right-3 md:top-10" onClick={onClose}>
                                <p className="hidden md:inline font-poppins text-[16px] text-[#000000] font-normal">
                                    Close
                                </p>
                                <Image src="/icons/close-mbl.png" alt="close" className="h-[10px] w-[10px] md:inline block" width={10} height={10} />
                        </div>
                    </div>
                ...
                {/* Right Side */}
                <div className="lg:w-[50%] w-full h-full bg-[#20403C] md:rounded-[112px] rounded-[42px] flex flex-col pt-[48px] pb-[48px] md:pt-[28px] md:pb-[48px] lg:pt-[52px] lg:pb-[96px] md:px-[99px] px-[20px] lg:px-[62px]">
                    {/* Close Button */}
                    <div className="justify-end w-full hidden lg:flex  mb-5 lg:mb-0">
                        <div
                                ...
                                >
                                    ...
                                    {loading ? (
                                        ...
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.95 }}
                                            className="flex items-center justify-center gap-5 lg:mt-2 mt-3 px-5 py-3 text-nowrap rounded-[12px] bg-black shadow-[4px_4px_0px_0px_#76A013] text-white font-poppins font-[500] lg:text-[18px] text-[14px] transition lg:w-[294px] mx-auto block lg:mx-0 w-[220px] md:max-w-[full]"
