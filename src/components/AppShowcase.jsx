...
export default function AppShowcase() {
    return (
        <section className="w-full flex justify-center ">
            <div className="w-full  py-20 max-[1540px]:max-w-full min-[1540px]:max-w-[1160px] ">
                {/* Scrollable container */}
                <div className="flex gap-6 overflow-x-auto pb-6 no-scrollbar snap-x snap-mandatory py-1 max-[1540px]:px-[180px] min-[1540px]:px-[6px]">
                    {features.map((item) => (
                        <div
                            key={item.id}
                            className="flex flex-col items-center justify-between flex-shrink-0 snap-center
                         w-[262px] px-[46px] pt-[30px] gap-[24px] rounded-[42px]
                         border border-[#DFDEFF] bg-[rgba(223,222,255,0.10)]
                         shadow-sm hover:scale-[1.02] transition-transform duration-300 min-w-[354px] "
                        >
                            {/* Image */}
                            ...
                            <div className="flex flex-col justify-center items-center gap-[12px]">
                                {/* Title */}
                                <h3 className="text-[#20403C] text-center font-poppins text-[16px] font-medium leading-[24px] max-w-[220px] min-h-[48px] capitalize">
                                    {item.title}
                                </h3>
                            ...
                            <div className="h-[136px] w-full flex justify-center items-center">
                                <Image src={item.img} alt={item.title} className="h-[136px] w-auto object-contain" />
                            </div>
                        </div>
                    ))}
                </div>
